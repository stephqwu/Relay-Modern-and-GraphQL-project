      ...
      try {
        yield Promise.all(artifacts.map((() => {
          var _ref3 = (0, _asyncToGenerator3.default)(function* (node) {
            ...
            !flowNode ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayFileWriter: did not compile flow types for: %s', node.name) : require('fbjs/lib/invariant')(false) : void 0;
