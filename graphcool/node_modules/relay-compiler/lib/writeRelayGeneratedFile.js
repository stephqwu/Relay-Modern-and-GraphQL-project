...
let writeRelayGeneratedFile = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (codegenDir, generatedNode, formatModule, flowText, _persistQuery, platform, relayRuntimeModule, sourceHash) {
    ...
    var flowTypeName = generatedNode.kind === require('relay-runtime').RelayConcreteNode.FRAGMENT ? 'ConcreteFragment' : generatedNode.kind === require('relay-runtime').RelayConcreteNode.REQUEST ? 'ConcreteRequest' : generatedNode.kind === require('relay-runtime').RelayConcreteNode.BATCH_REQUEST ? 'ConcreteBatchRequest' : 'empty';
    var devOnlyProperties = {};

    var docText = void 0;
    if (generatedNode.kind === require('relay-runtime').RelayConcreteNode.REQUEST) {
      docText = generatedNode.text;
    } else if (generatedNode.kind === require('relay-runtime').RelayConcreteNode.BATCH_REQUEST) {
    ...
    var hash = null;
    if (generatedNode.kind === require('relay-runtime').RelayConcreteNode.REQUEST || generatedNode.kind === require('relay-runtime').RelayConcreteNode.BATCH_REQUEST) {
      var oldHash = require('graphql-compiler').Profiler.run('RelayFileWriter:compareHash', function () {
      ...
      if (persistQuery) {
        switch (generatedNode.kind) {
          case require('relay-runtime').RelayConcreteNode.REQUEST:
            ...
            break;
          case require('relay-runtime').RelayConcreteNode.BATCH_REQUEST:
            ...
            break;
          case require('relay-runtime').RelayConcreteNode.FRAGMENT:
