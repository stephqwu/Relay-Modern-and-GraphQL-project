...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("relay-runtime"), require("react"), require("babel-runtime/helpers/extends"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("babel-runtime/helpers/objectWithoutProperties"), require("fbjs/lib/mapObject"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/base62"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "relay-runtime", "react", "babel-runtime/helpers/extends", "babel-runtime/helpers/classCallCheck", "fbjs/lib/warning", "fbjs/lib/areEqual", "fbjs/lib/sprintf", "babel-runtime/helpers/inherits", "babel-runtime/helpers/possibleConstructorReturn", "prop-types", "babel-runtime/helpers/objectWithoutProperties", "fbjs/lib/mapObject", "babel-runtime/helpers/defineProperty", "fbjs/lib/base62", "fbjs/lib/forEachObject", "fbjs/lib/nullthrows"], factory);
	else if(typeof exports === 'object')
		exports["ReactRelayCompat"] = factory(require("fbjs/lib/invariant"), require("relay-runtime"), require("react"), require("babel-runtime/helpers/extends"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/warning"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("babel-runtime/helpers/objectWithoutProperties"), require("fbjs/lib/mapObject"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/base62"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"));
	else
		root["ReactRelayCompat"] = factory(root["fbjs/lib/invariant"], root["relay-runtime"], root["react"], root["babel-runtime/helpers/extends"], root["babel-runtime/helpers/classCallCheck"], root["fbjs/lib/warning"], root["fbjs/lib/areEqual"], root["fbjs/lib/sprintf"], root["babel-runtime/helpers/inherits"], root["babel-runtime/helpers/possibleConstructorReturn"], root["prop-types"], root["babel-runtime/helpers/objectWithoutProperties"], root["fbjs/lib/mapObject"], root["babel-runtime/helpers/defineProperty"], root["fbjs/lib/base62"], root["fbjs/lib/forEachObject"], root["fbjs/lib/nullthrows"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_31__, __WEBPACK_EXTERNAL_MODULE_44__, __WEBPACK_EXTERNAL_MODULE_45__, __WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__) {
	...
	var QueryBuilder = {
	  ...
	  createQuery: function createQuery(partialQuery) {
	    ...
	    if (identifyingArgName != null) {
	       true ? __webpack_require__(10)(partialQuery.identifyingArgValue != null, 'QueryBuilder.createQuery(): An argument value may be required for ' + 'query `%s(%s: ???)`.', partialQuery.fieldName, identifyingArgName) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var containerContextTypes = {
	  relay: __webpack_require__(9).Relay
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompatMutations = {
	  commitUpdate: function commitUpdate(environment, config) {
	    var relayStaticEnvironment = __webpack_require__(14).getRelayModernEnvironment(environment);
	    if (relayStaticEnvironment) {
	      return __webpack_require__(2).commitMutation(relayStaticEnvironment, config);
	    } else {
	      var relayClassicEnvironment = __webpack_require__(14).getRelayClassicEnvironment(environment);
	...
	function commitRelayClassicMutation(environment, _ref) {
	  ...
	  if (typeof optimisticResponse === 'function') {
	     true ? __webpack_require__(10)(false, 'RelayCompatMutations: Expected `optimisticResponse` to be an object, ' + 'received a function.') : void 0;
	  ...
	  if (operation.node.kind === 'Mutation' && operation.node.calls && operation.node.calls.length === 1) {
	    ...
	    if (optimisticResponse[mutationRoot]) {
	      return optimisticResponse[mutationRoot];
	       ...
	       true ? __webpack_require__(10)(false, 'RelayCompatMutations: Expected result from `optimisticResponse`' + 'to contain the mutation name `%s` as a property, got `%s`', mutationRoot, optimisticResponse) : void 0;
	    }
	  }
	  ...
	  RelayFragmentReference.prototype.getVariables = function getVariables(route, variables) {
	    ...
	    if (variableMapping) {
	      __webpack_require__(46)(variableMapping, function (value, name) {
	        ...
	        if (value === undefined) {
	           true ? __webpack_require__(10)(false, 'RelayFragmentReference: Variable `%s` is undefined in fragment ' + '`%s`.', name, _this.getFragmentUnconditional().name) : void 0;
	        } else {
	...
	function createContainerWithFragments(Component, fragments) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    Container.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
	      ...
	      if (prevState.relayEnvironment !== relay.environment || prevState.relayVariables !== relay.variables || !__webpack_require__(11)(prevIDs, nextIDs)) {
	        // Do not provide a subscription/callback here.
	        // It is possible for this render to be interrupted or aborted,
	        // In which case the subscription would cause a leak.
	  ...
	  __webpack_require__(18).profileContainer(Container, 'ReactRelayFragmentContainer');
	...
	function createContainerWithFragments(Component, fragments, connectionConfig) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    function Container(props, context) {
	      ...
	      _this._loadMore = function (pageSize, observerOrCallback, options) {
	        ...
	        var cursor = connectionData.cursor;
	         true ? __webpack_require__(10)(cursor, 'ReactRelayPaginationContainer: Cannot `loadMore` without valid `%s` (got `%s`)', direction === FORWARD ? END_CURSOR : START_CURSOR, cursor) : void 0;
	        var paginatingVariables = {
	          count: pageSize,
	          cursor: cursor,
	          totalCount: totalCount
	    ...
	    Container.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps, nextContext) {
	      ...
	      // - Existing references are based on old variables.
	      // - Pending fetches are for the previous records.
	      if (this.state.relayEnvironment !== relay.environment || this.state.relayVariables !== relay.variables || !__webpack_require__(11)(prevIDs, nextIDs)) {
	        this._cleanup();
	    ...
	    Container.prototype._getConnectionData = function _getConnectionData() {
	      ...
	      if (typeof hasMore !== 'boolean' || edges.length !== 0 && typeof cursor === 'undefined') {
	         true ? __webpack_require__(10)(false, 'ReactRelayPaginationContainer: Cannot paginate without %s fields in `%s`. ' + 'Be sure to fetch %s (got `%s`) and %s (got `%s`).', PAGE_INFO, componentName, direction === FORWARD ? HAS_NEXT_PAGE : HAS_PREV_PAGE, hasMore, direction === FORWARD ? END_CURSOR : START_CURSOR, cursor) : void 0;
	        return null;
	      }
	      return {
	        cursor: cursor,
	    ...
	    Container.prototype._getQueryFetcher = function _getQueryFetcher() {
	      if (!this._queryFetcher) {
	        this._queryFetcher = new (__webpack_require__(19))();
	      }
	  ...
	  __webpack_require__(18).profileContainer(Container, 'ReactRelayPaginationContainer');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactRelayQueryRenderer = function (_React$Component) {
	  ...
	  function ReactRelayQueryRenderer(props, context) {
	    ...
	    var queryFetcher = new (__webpack_require__(19))();
	  ...
	  ReactRelayQueryRenderer.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
	    if (prevState.prevQuery !== nextProps.query || prevState.prevPropsEnvironment !== nextProps.environment || !__webpack_require__(11)(prevState.prevPropsVariables, nextProps.variables)) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createContainerWithFragments(Component, fragments, taggedNode) {
	  ...
	  __webpack_require__(18).profileContainer(Container, 'ReactRelayRefetchContainer');
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	function createContainer(Component, fragmentSpec) {
	  return __webpack_require__(13).buildCompatContainer(Component, fragmentSpec, __webpack_require__(32).createContainerWithFragments,
	  /* provides child context */false);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	function createContainer(Component, fragmentSpec, connectionConfig) {
	  return __webpack_require__(13).buildCompatContainer(Component, fragmentSpec, function (ComponentClass, fragments) {
